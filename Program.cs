...
object services = builder.Services.AddBlazorBootstrap();
...
if (!app.Environment.IsDevelopment())
{
    ...
    // The default HSTS services is 30 days. You may want to change this for production scenarios, see https://aka.ms/aspnetcore-hsts.
    app.UseHsts();
}
